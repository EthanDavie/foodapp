...
import { createIngredients } from "../graphql/mutations";
const client = generateClient();
export default function IngredientsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setFood_name(initialValues.food_name);
    setErrors({});
  };
  const validations = {
    food_name: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createIngredients.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "IngredientsCreateForm")}
      {...rest}
    >
      <TextField
